...
class MujocoEnv(gym.Env):
    ...
    def __init__(self, frame_skip, env_name="Hopper"):
    ...
    def build_model(self):
        ...
        elif self.name == "Walker2d":
            self.model = mujoco_py.load_model_from_path(os.path.join(os.path.dirname(__file__), "assets/walker2d.xml"))
        else:
